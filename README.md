...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/SAI0969/Time_complexity.git
   cd Time_complexity
   ```
...
├── Singly_Linked_Lists_Collapsible.html
├── Doubly_Linked_Lists_Collapsible.html
├── Circularly_Linked_Lists_Collapsible.html
├── Stack.html
├── Queue.html
├── Binary_Tree.html
